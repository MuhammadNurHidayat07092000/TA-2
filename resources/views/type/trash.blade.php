        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a href="{{ url('types/delete') }}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau hapus semua data?')">
                        <i class="fa fa-trash"></i>Delete All
                    </a>
                
                    <a href="{{ url('types/restore') }}" class="btn btn-info btn-sm">
